const TEXT_MAP = new Map([
  ...
  ['Invoice OCR + AI Review Workflow', 'Invoice OCR + AI Review Workflow'],
  ...
  ['검수 필요 0건', 'Review Required: 0'],
  ['예상 KRW', 'Estimated KRW'],
...
function injectAiInvoiceStyles() {
  ...
  style.textContent = `
    ...
    .aiSummary span{
      display:flex;justify-content:space-between;align-items:center;width:100%;padding:12px 14px;border-radius:12px;background:linear-gradient(90deg,#eaf7ff,#f7fff1);border:1px solid #e5e7eb;color:#0f172a;font-weight:900;
    }
    .aiForm{
      display:grid !important;
      grid-template-columns:1fr !important;
